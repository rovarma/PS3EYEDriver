...
ELSE (LIBUSB_INCLUDE_DIR AND LIBUSB_LIBRARIES)
    IF(${CMAKE_SYSTEM_NAME} MATCHES "Windows")
        set(LIBUSB_ROOT ${CMAKE_CURRENT_LIST_DIR}/../../libusb-1.0)
    ELSEIF(${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
        execute_process(COMMAND brew --prefix libusb OUTPUT_VARIABLE LIBUSB_ROOT)
        STRING(STRIP ${LIBUSB_ROOT} LIBUSB_ROOT)
    ENDIF()
